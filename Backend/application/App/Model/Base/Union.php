...
/**
 * Base class that represents a row from the 'chrono_union' table.
 *
 *
 *
 * @package    propel.generator.App.Model.Base
 */
abstract class Union implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\UnionTableMap';
     ...
     *
     * Note: this column has a database default value of: '#888888'
     * @var        string
     */
    protected $color;
    ...
    /**
     * Initializes internal state of App\Model\Base\Union object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Union</code> instance.  If
     * <code>obj</code> is an instance of <code>Union</code>, delegates to
     * <code>equals(Union)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Union The current object, for fluid interface
     */
     ...
     * @return $this|\App\Model\Union The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UnionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[UnionTableMap::COL_NAME] = true;
        }
    ...
    public function setColor($v)
    {
        ...
        if ($this->color !== $v) {
            $this->color = $v;
            $this->modifiedColumns[UnionTableMap::COL_COLOR] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UnionTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UnionTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UnionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UnionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UnionTableMap::translateFieldName('Color', TableMap::TYPE_PHPNAME, $indexType)];
            $this->color = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UnionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UnionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = UnionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Union'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUnionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUnionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UnionTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(UnionTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(UnionTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                UnionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[UnionTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UnionTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UnionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UnionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(UnionTableMap::COL_COLOR)) {
        ...
        $sql = sprintf(
            'INSERT INTO chrono_union (%s) VALUES (%s)',
    ...
    {
        $pos = UnionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Union'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Union'][$this->hashCode()] = true;
        $keys = UnionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Union The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(UnionTableMap::DATABASE_NAME);

        if ($this->isColumnModified(UnionTableMap::COL_ID)) {
            $criteria->add(UnionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UnionTableMap::COL_NAME)) {
            $criteria->add(UnionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(UnionTableMap::COL_COLOR)) {
            $criteria->add(UnionTableMap::COL_COLOR, $this->color);
        }
        if ($this->isColumnModified(UnionTableMap::COL_CREATED_AT)) {
            $criteria->add(UnionTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(UnionTableMap::COL_UPDATED_AT)) {
            $criteria->add(UnionTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildUnionQuery::create();
        $criteria->add(UnionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Union (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Union Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPlayers($overrideExisting = true)
    {
        ...
        $this->collPlayers = new $collectionClassName;
        $this->collPlayers->setModel('\App\Model\Player');
    }
     ...
     * If this ChildUnion is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildUnion The current object (for fluent API support)
     */
    ...
    public function addPlayer(ChildPlayer $l)
    {
        ...
        if (!$this->collPlayers->contains($l)) {
            ...
            if ($this->playersScheduledForDeletion and $this->playersScheduledForDeletion->contains($l)) {
                $this->playersScheduledForDeletion->remove($this->playersScheduledForDeletion->search($l));
            }
        }
    ...
    {
        return (string) $this->exportTo(UnionTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('color', new NotBlank());
        $metadata->addPropertyConstraint('color', new Regex(array ('pattern' => '/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/',)));
    }
