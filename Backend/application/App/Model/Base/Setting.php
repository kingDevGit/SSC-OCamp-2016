...
/**
 * Base class that represents a row from the 'chrono_setting' table.
 *
 *
 *
...
abstract class Setting implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\SettingTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Setting object.
     */
     ...
     * @return $this|\App\Model\Setting The current object (for fluent API support)
     */
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[SettingTableMap::COL_CONTENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SettingTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Setting'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SettingTableMap::COL_CONTENT)) {
            $modifiedColumns[':p' . $index++]  = 'content';
        }

        $sql = sprintf(
            'INSERT INTO chrono_setting (%s) VALUES (%s)',
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Setting The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingTableMap::COL_CONTENT)) {
            $criteria->add(SettingTableMap::COL_CONTENT, $this->content);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Setting (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Setting Clone of current object.
     * @throws PropelException
     */
