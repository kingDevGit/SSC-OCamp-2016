...
use App\Model\Map\AccountTableMap;
...
/**
 * Base class that represents a row from the 'chrono_account' table.
 *
 *
 *
...
abstract class Account implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\AccountTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Account object.
     */
     ...
     * @return $this|\App\Model\Account The current object (for fluent API support)
     */
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[AccountTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AccountTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccountTableMap::translateFieldName('Hash', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Account'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_PLAYER_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO chrono_account (%s) VALUES (%s)',
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Account The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_PLAYER_ID)) {
            $criteria->add(AccountTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(AccountTableMap::COL_EMAIL)) {
    ...
    public function hashCode()
    {
        ...
        //relation chrono_account_fk_46d202 to table chrono_player
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Account (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Account Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aPlayer) {
            $this->aPlayer->removeAccount($this);
        }
        $this->player_id = null;
        $this->email = null;
        $this->hash = null;
    ...
    public function validate(ValidatorInterface $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            if (method_exists($this->aPlayer, 'validate')) {
                if (!$this->aPlayer->validate($validator)) {
                    $failureMap->addAll($this->aPlayer->getValidationFailures());
                }
            }
