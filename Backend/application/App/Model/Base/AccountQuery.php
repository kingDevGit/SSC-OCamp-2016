...
/**
 * Base class that represents a query for the 'chrono_account' table.
 *
 *
 *
 * @method     ChildAccountQuery orderByPlayerId($order = Criteria::ASC) Order by the player_id column
 ...
 *
 * @method     ChildAccountQuery groupByPlayerId() Group by the player_id column
 ...
 *
 * @method     ChildAccountQuery leftJoinPlayer($relationAlias = null) Adds a LEFT JOIN clause to the query using the Player relation
 * @method     ChildAccountQuery rightJoinPlayer($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Player relation
 * @method     ChildAccountQuery innerJoinPlayer($relationAlias = null) Adds a INNER JOIN clause to the query using the Player relation
 *
 * @method     ChildAccountQuery joinWithPlayer($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Player relation
 *
 * @method     ChildAccountQuery leftJoinWithPlayer() Adds a LEFT JOIN clause and with to the query using the Player relation
 * @method     ChildAccountQuery rightJoinWithPlayer() Adds a RIGHT JOIN clause and with to the query using the Player relation
 * @method     ChildAccountQuery innerJoinWithPlayer() Adds a INNER JOIN clause and with to the query using the Player relation
 *
 ...
 *
 * @method     ChildAccount findOneByPlayerId(int $player_id) Return the first ChildAccount filtered by the player_id column
 ...
 *
 * @method     ChildAccount requireOneByPlayerId(int $player_id) Return the first ChildAccount filtered by the player_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildAccount[]|ObjectCollection findByPlayerId(int $player_id) Return ChildAccount objects filtered by the player_id column
...
abstract class AccountQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Model\Base\AccountQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'chrono', $modelName = '\\App\\Model\\Account', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT player_id, email, hash, created_at, updated_at FROM chrono_account WHERE player_id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByPlayerId($playerId = null, $comparison = null)
    {
        if (is_array($playerId)) {
            ...
            if (isset($playerId['min'])) {
                $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $playerId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($playerId['max'])) {
                $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $playerId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $playerId, $comparison);
    }
    ...
    public function filterByPlayer($player, $comparison = null)
    {
        if ($player instanceof \App\Model\Player) {
            return $this
                ->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $player->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $player->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($account) {
            $this->addUsingAlias(AccountTableMap::COL_PLAYER_ID, $account->getPlayerId(), Criteria::NOT_EQUAL);
        }
