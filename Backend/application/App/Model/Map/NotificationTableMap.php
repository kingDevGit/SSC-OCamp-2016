...
/**
 * This class defines the structure of the 'chrono_notification' table.
 *
 *
 *
...
class NotificationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.NotificationTableMap';
     ...
     */
    const TABLE_NAME = 'chrono_notification';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Model\\Notification';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Notification';
     ...
     */
    const COL_ID = 'chrono_notification.id';

    /**
     * the column name for the to_player field
     */
    const COL_TO_PLAYER = 'chrono_notification.to_player';

    /**
     * the column name for the message field
     */
    const COL_MESSAGE = 'chrono_notification.message';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'chrono_notification.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'chrono_notification.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ToPlayer', 'Message', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'toPlayer', 'message', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(NotificationTableMap::COL_ID, NotificationTableMap::COL_TO_PLAYER, NotificationTableMap::COL_MESSAGE, NotificationTableMap::COL_CREATED_AT, NotificationTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'to_player', 'message', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ToPlayer' => 1, 'Message' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'toPlayer' => 1, 'message' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(NotificationTableMap::COL_ID => 0, NotificationTableMap::COL_TO_PLAYER => 1, NotificationTableMap::COL_MESSAGE => 2, NotificationTableMap::COL_CREATED_AT => 3, NotificationTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'to_player' => 1, 'message' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        // attributes
        $this->setName('chrono_notification');
        $this->setPhpName('Notification');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\App\\Model\\Notification');
        $this->setPackage('App.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('to_player', 'ToPlayer', 'INTEGER', 'chrono_player', 'id', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NotificationTableMap::COL_TO_PLAYER);
            $criteria->addSelectColumn(NotificationTableMap::COL_MESSAGE);
            ...
            $criteria->addSelectColumn($alias . '.to_player');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Notification) { // it's a model object
