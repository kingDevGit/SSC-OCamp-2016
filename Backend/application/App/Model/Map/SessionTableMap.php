...
/**
 * This class defines the structure of the 'chrono_session' table.
 *
 *
 *
...
class SessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.SessionTableMap';
     ...
     */
    const TABLE_NAME = 'chrono_session';
     ...
     */
    const CLASS_DEFAULT = 'App.Model.Session';
     ...
     */
    const COL_TOKEN = 'chrono_session.token';

    /**
     * the column name for the player_id field
     */
    const COL_PLAYER_ID = 'chrono_session.player_id';

    /**
     * the column name for the expired_at field
     */
    const COL_EXPIRED_AT = 'chrono_session.expired_at';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'chrono_session.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'chrono_session.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Token', 'PlayerId', 'ExpiredAt', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('token', 'playerId', 'expiredAt', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_TOKEN, SessionTableMap::COL_PLAYER_ID, SessionTableMap::COL_EXPIRED_AT, SessionTableMap::COL_CREATED_AT, SessionTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('token', 'player_id', 'expired_at', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Token' => 0, 'PlayerId' => 1, 'ExpiredAt' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('token' => 0, 'playerId' => 1, 'expiredAt' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_TOKEN => 0, SessionTableMap::COL_PLAYER_ID => 1, SessionTableMap::COL_EXPIRED_AT => 2, SessionTableMap::COL_CREATED_AT => 3, SessionTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('token' => 0, 'player_id' => 1, 'expired_at' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionTableMap::COL_PLAYER_ID);
