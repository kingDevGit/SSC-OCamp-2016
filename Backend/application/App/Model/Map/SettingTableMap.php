...
/**
 * This class defines the structure of the 'chrono_setting' table.
 *
 *
 *
...
class SettingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.SettingTableMap';
     ...
     */
    const TABLE_NAME = 'chrono_setting';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Model\\Setting';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Setting';
     ...
     */
    const COL_NAME = 'chrono_setting.name';

    /**
     * the column name for the content field
     */
    const COL_CONTENT = 'chrono_setting.content';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Content', ),
        self::TYPE_CAMELNAME     => array('name', 'content', ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_NAME, SettingTableMap::COL_CONTENT, ),
        self::TYPE_FIELDNAME     => array('name', 'content', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Content' => 1, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'content' => 1, ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_NAME => 0, SettingTableMap::COL_CONTENT => 1, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'content' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('chrono_setting');
        $this->setPhpName('Setting');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\App\\Model\\Setting');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingTableMap::COL_CONTENT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Setting) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(SettingTableMap::DATABASE_NAME);
            $criteria->add(SettingTableMap::COL_NAME, (array) $values, Criteria::IN);
        }
